...
/***/ "./src/admin/components/SpanishSettingsModal.js":
/*!******************************************************!*\
  !*** ./src/admin/components/SpanishSettingsModal.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SpanishSettingsModal; });
...
var SpanishSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(SpanishSettingsModal, _SettingsModal);

  function SpanishSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = SpanishSettingsModal.prototype;
  ...
  _proto.form = function form() {
    ...
    }, m("legend", null, "Mode"), m("label", {
      class: "checkbox"
    }, m("input", {
      type: "radio",
      bidi: this.setting('darkfoxdeveloper-spanish.mode'),
      value: "formal"
    }), "Formal"), m("label", {
      class: "checkbox"
    }, m("input", {
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('darkfoxdeveloper-spanish', function (app) {
  app.extensionSettings['darkfoxdeveloper-spanish'] = function () {
    return app.modal.show(new _components_SpanishSettingsModal__WEBPACK_IMPORTED_MODULE_2__["default"]());
  };
});
